...
namespace Mont.Sintactico
{
    ...
    {
        public bool detectoIntentoFrenarMotor()
        {
            try
            {
                ...
                if (Regex.Replace(tipoTokenActual, " ", "").Equals("Clase"))
                {
                    ...
                    if (Regex.Replace(tokenActual, " ", "").Equals("."))
                    {
                        ...
                        if (Regex.Replace(tokenActual, " ", "").Equals("frenar"))
                        {
        ...
        public bool comprobarMotorFrenar()
        {
            ...
            try
            {
                ...
                tokenActual = arregloTokensEncontrados[indiceGeneral].palabra;
                if (tokenActual.Equals("frenar"))
                {
                    expresionesDentrodeCiclo += "frenar";
                    motorOrdenEjecucion.ejecucion = "frenar";
                    indiceGeneral++;
                }
                else
                {
